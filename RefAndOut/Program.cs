...
class ReferenceAndOutputParameters
{
    ...
    {
        int y = 5; //inintialization of y to 5
        ...
        //methods SquareRef ans SquareOut, respectively
